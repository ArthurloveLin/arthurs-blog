...
export const INTERNAL_SEARCH_ITEMS: InternalLinkItem[] = [
  {
    ...
    href: '/life-gallery',
    title: 'Life Gallery',
    summary: '我的生活画廊与轮播图集 - Arthur and Grace 的生活瞬间',
    tags: ['生活', '画廊', '图集', 'Gallery', 'Photo', '展示'],
    category: '站内工具',
  },
  {
    id: 'internal-life-lens',
    href: '/wardrobe',
    title: 'Life Lens',
    summary: '记录真实评价的决策系统 - 穿搭与物品质量调研',
    tags: ['评价', '穿搭', '决策', 'Lens', 'Wardrobe', 'Review', '物品', '质量'],
    category: '站内工具',
  },
  {
    id: 'internal-news',
  ...
  },
  {
    ...
    href: '/guestbook',
    title: 'Message',
    summary: '留言板 - 留下你的印记，与 Arthur & Grace 互动',
