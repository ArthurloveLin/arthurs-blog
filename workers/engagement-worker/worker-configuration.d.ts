/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ac613c0f11b4984b731b90a124c2fea)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CommentQueueDurableObject" | "CommentRateLimiterDurableObject" | "PostReactionDurableObject";
	}
	interface Env {
		ORIGIN_BASE_URL: "https://arthurlovegrace.top";
		CORS_ALLOW_ORIGIN: "*";
		SUPABASE_URL: "https://api.arthurlovegrace.top";
		COMMENT_MAX_LENGTH: 500;
		COMMENT_URL_LIMIT: 2;
		COMMENT_BLOCKED_TERMS: "博彩,裸聊,刷单,代刷,纸飞机,telegram,免费兼职,加v,加微";
		COMMENT_RATE_LIMIT_MAX_REQUESTS: 5;
		COMMENT_RATE_LIMIT_WINDOW_SECONDS: 60;
		REACTION_FLUSH_INTERVAL_SECONDS: 300;
		REACTION_FLUSH_RETRY_SECONDS: 60;
		COMMENT_QUEUE_DO: DurableObjectNamespace<import("./src/index").CommentQueueDurableObject>;
		COMMENT_RATE_LIMITER: DurableObjectNamespace<import("./src/index").CommentRateLimiterDurableObject>;
		POST_REACTION_DO: DurableObjectNamespace<import("./src/index").PostReactionDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_BASE_URL" | "CORS_ALLOW_ORIGIN" | "SUPABASE_URL" | "COMMENT_MAX_LENGTH" | "COMMENT_URL_LIMIT" | "COMMENT_BLOCKED_TERMS" | "COMMENT_RATE_LIMIT_MAX_REQUESTS" | "COMMENT_RATE_LIMIT_WINDOW_SECONDS" | "REACTION_FLUSH_INTERVAL_SECONDS" | "REACTION_FLUSH_RETRY_SECONDS">> {}
}
