...
export default function BlogHero({ guestbookBoard, initialGuestbookMessages }: BlogHeroProps) {
  ...
  return (
    <div className="relative border-b border-border bg-background overflow-hidden">
      ...
      <div className="site-container relative z-10 pt-14 pb-12 lg:pt-20 lg:pb-16">
        ...
        <div className="relative z-10">
          ...
          <h1 className="max-w-xl text-[2.15rem] font-semibold leading-[1.12] tracking-tight text-foreground lg:max-w-2xl lg:text-[2.8rem]">
          ...
          <p className="mt-4 max-w-md text-[0.95rem] leading-relaxed text-muted-foreground lg:max-w-lg">
