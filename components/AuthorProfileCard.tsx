...
export default function AuthorProfileCard({
  ...
  return (
    <div className="bg-card text-card-foreground rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none transition duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-6 relative group border border-border/50 dark:border-white/10 z-10 hover:z-30">
      ...
      <div className="flex justify-center">
        <div className="relative">
          {avatarUrl ? (
            <div className="relative w-22 h-22 rounded-full overflow-hidden shadow-[0_4px_16px_rgb(0,0,0,0.12)] border-2 border-background bg-muted">
              <Image src={avatarUrl} alt={name} fill className="object-cover" unoptimized />
            </div>
          ) : (
            <div className="w-22 h-22 rounded-full bg-gradient-primary flex items-center justify-center shadow-[0_4px_16px_rgb(0,0,0,0.12)] border-2 border-background dark:border-white/10">
              <span className="text-primary-foreground text-sm font-bold tracking-tight">A&G</span>
            </div>
          )}
          
          {/* Status Badge */}
          {statusEmoji && (
            <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-card border border-border rounded-full flex items-center justify-center shadow-md text-sm animate-bounce-subtle z-10 select-none">
              {statusEmoji}
            </div>
          )}
        </div>
      ...
      <div className="text-center mt-5">
        <h2 className="text-xl font-bold text-gradient-primary tracking-tight">{name}</h2>
