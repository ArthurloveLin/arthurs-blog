      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${compact ? 'max-h-0 opacity-0' : 'max-h-20 opacity-100'}`}>
        <div className="flex justify-center gap-2 mb-6">
          ...
          {weibo && (
            ...
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 3333 3333" aria-hidden="true">
          ...
          {wechat && (
            ...
            >
              ...
              <svg className="w-5 h-5 transition-opacity duration-150 group-hover/wechat:opacity-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
